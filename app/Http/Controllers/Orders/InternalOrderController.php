...
{
    public function __construct(private InternalOrderService $service, private UserService $userService, private ProductService $productService, private SanctionEnforcementService $sanctionService) {}
