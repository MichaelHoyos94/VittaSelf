...
export default function Show() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        expected_bank_transfer:
            cashRegisterClosure.cash_register?.bank_transfer,
    ...
    return (
        <div className="bg-white/80 p-6 rounded-xl shadow-lg backdrop-blur-lg min-h-full space-y-2">
            ...
            <h2 className="text-2xl font-bold">
                Cash Register Closure Details
            </h2>
            <p className="text-sm text-gray-500">
                Detailed cash register closure info for audit.
            </p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData("counted_cash", e.target.value)
                                    }
